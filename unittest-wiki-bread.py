...
class ChromeSearch(unittest.TestCase):
    ...
    def test_wiki_bread_chrome(self):
        ...
        print("Google URL has", requests.get("https://www.google.com/").status_code, "as a status code")
        ...
        code_wiki = requests.get("https://www.wikipedia.org/").status_code
        ...
        wait.until(EC.visibility_of_element_located((By.XPATH, "//h1//span[contains(text(), 'Wikipedia')]")))
        ...
        search_bar_wiki = driver.find_element(By.ID, "searchInput")
        search_bar_wiki.clear()
        search_bar_wiki.send_keys("bread", Keys.RETURN)

        wait.until(EC.visibility_of_element_located((By.XPATH, '//span[@class = "mw-page-title-main"]')))
        print("The bread page has its heading:",
              driver.find_element(By.XPATH, '//span[@class = "mw-page-title-main"]').text)
        ...
        driver.find_element(By.XPATH, '//img[@alt = "Loaves of bread in a basket"]').click()

        delay()

        try:
            wait.until(EC.presence_of_element_located(
                (By.XPATH, '//img[@alt = "Loaves of bread in a basket"]')))
